...
#
# DESCRIPTION
# This implements the 'autoboot-partition' source plugin class for
...
class AutobootPartitionPlugin(SourcePlugin):
    ...
    def do_prepare_partition(cls, part, source_params, cr, cr_workdir,
        ...
        logger.debug('Kernel dir: %s', autoboot_dir)
